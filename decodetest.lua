...
--[[ strace decode
{
	{len=1440, type=RTM_NEWLINK, flags=0, seq=0, pid=0},
	{ifi_family=AF_UNSPEC, ifi_type=ARPHRD_NONE, ifi_index=if_nametoindex("wg3"), ifi_flags=IFF_POINTOPOINT|IFF_NOARP, ifi_change=0xffffffff},
	[
		{{nla_len=8, nla_type=IFLA_IFNAME}, "wg3"},
		{{nla_len=8, nla_type=IFLA_TXQLEN}, 1000},
		{{nla_len=5, nla_type=IFLA_OPERSTATE}, 2},
		{{nla_len=5, nla_type=IFLA_LINKMODE}, 0},
		{{nla_len=8, nla_type=IFLA_MTU}, 1420},
		{{nla_len=8, nla_type=IFLA_MIN_MTU}, 0},
		{{nla_len=8, nla_type=IFLA_MAX_MTU}, 2147483552},
		{{nla_len=8, nla_type=IFLA_GROUP}, 0},
		{{nla_len=8, nla_type=IFLA_PROMISCUITY}, 0},
		{{nla_len=8, nla_type=0x3d /* IFLA_??? */}, "\x00\x00\x00\x00"},
		...
		{{nla_len=8, nla_type=0x3a /* IFLA_??? */}, "\x00\x00\x01\x00"},
		{{nla_len=8, nla_type=0x3f /* IFLA_??? */}, "\x00\x00\x01\x00"},
		{{nla_len=8, nla_type=0x40 /* IFLA_??? */}, "\x00\x00\x01\x00"},
		...
		{{nla_len=204, nla_type=IFLA_STATS64}, {rx_packets=0, tx_packets=0, rx_bytes=0, tx_bytes=0, rx_errors=0, tx_errors=0, rx_dropped=0, tx_dropped=0, multicast=0, collisions=0, rx_length_errors=0, rx_over_errors=0, rx_crc_errors=0, rx_frame_errors=0, rx_fifo_errors=0, rx_missed_errors=0, tx_aborted_errors=0, tx_carrier_errors=0, tx_fifo_errors=0, tx_heartbeat_errors=0, tx_window_errors=0, rx_compressed=0, tx_compressed=0, rx_nohandler=0}},
		{{nla_len=100, nla_type=IFLA_STATS}, {rx_packets=0, tx_packets=0, rx_bytes=0, tx_bytes=0, rx_errors=0, tx_errors=0, rx_dropped=0, tx_dropped=0, multicast=0, collisions=0, rx_length_errors=0, rx_over_errors=0, rx_crc_errors=0, rx_frame_errors=0, rx_fifo_errors=0, rx_missed_errors=0, tx_aborted_errors=0, tx_carrier_errors=0, tx_fifo_errors=0, tx_heartbeat_errors=0, tx_window_errors=0, rx_compressed=0, tx_compressed=0, rx_nohandler=0}},
		{{nla_len=12, nla_type=IFLA_XDP}, {{nla_len=5, nla_type=IFLA_XDP_ATTACHED}, XDP_ATTACHED_NONE}},
		{{nla_len=20, nla_type=IFLA_LINKINFO}, {{nla_len=14, nla_type=IFLA_INFO_KIND}, "wireguard"}},
		{
			{nla_len=824, nla_type=IFLA_AF_SPEC},
			[
				{{nla_len=12, nla_type=0x2d /* AF_??? */}, "\x08\x00\x01\x00\x01\x00\x00\x00"},
				{
